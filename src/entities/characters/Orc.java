...
public class Orc extends Humanoid {
    ...
    public void init() {
        ...
        setWidth(32);
        this.setBaseSpeed(2);
        this.setBaseStat(FIRE_RESIST, 10);
        this.setBaseStat(WATER_RESIST, -10);
        imageYOffset = 16;
        imageXOffset = 16;
    ...
    private void rotatedDrawTheMan(int spritex, int spritey, float sx, float sy, float zoom, Graphics g) {
        ...
        SpriteSheet headsheet = Images.orcHeadSheet;
        SpriteSheet chestsheet = Images.orcChestSheet;
        SpriteSheet legssheet = Images.orcLegsSheet;
        int step = stepNum / Humanoid.STEPRATIO;
        Image hand = Images.orcHand;
